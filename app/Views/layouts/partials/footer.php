<div class="row d-flex justify-content-center align-items-center mt-5" style="background: #cee6e6;">
...
<!-- Footer -->
<footer class="" style="background-image: url(<?= base_url('assets/img/footer.png'); ?>);">
    <div class="container">
        <div class="row">
            <div class="col pt-5 pb-4">
                <div class="row gap-5 py-3 d-flex justify-content-between "  style="height: 220px;">
                    <div class="col-6">
                        <h3 class="text-white" >INKINDO YOGYAKARTA</h3>
                        <p class="text-white mt-3" >Ikatan Nasional Konsultan Indonesia (INKINDO) merupakan Asosiasi Perusahaan Jasa Konsultan di Indonesia yang di dirikan pada tanggal 20 Juni 1979 di Jakarta.</p>
                    </div>
                    <div class="col-4 text-white">
                        <h5>Kontak</h5>
                        <div class="col d-flex align-items-center" >
                            <i class="fa fa-envelope me-3"></i>
                            <p class="mt-3" >inkindo@inkindo.org</p>
                        </div>
                        <div class="col d-flex align-items-center" >
                            <i class="fa fa-phone-alt me-3"></i>
                            <p class="mt-3" >081315289207</p>
                        </div>
                        <div class="col d-flex align-items-center" >
                            <i class="fa fa-map me-3"></i>
                            <p class="mt-3" >Jl. Kenari No. 29, Yogyakarta 10210g</p>
                        </div>
                    </div>
                </div>
                <hr / class="text-white">
                <div class="row mt-4 justify-content-between align-items-center ">
                    <div class="col-6 ">
                        <h6 class="text-white" >© INKINDO D.I. YOGYAKARTA - All Right Reserved</h6>
                    </div>
                    <div class="col-3">
                    <ul class="list-inline fs-3 mb-0 text-white d-flex flex-row-reverse px-1 justify-content-evenly">
